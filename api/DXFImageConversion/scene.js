 ...
 * @constructor
 */
function Viewer(data, width, height) {
    ...
    // var renderer = this.renderer = new THREE.WebGLRenderer( {context: gl, preserveDrawingBuffer: true} );
...
//        camera.updateProjectionMatrix();
 ...
 //    var strMime = "image/jpeg";
	// var dataURI = renderer.domElement.toDataURL(strMime);
...
ReadRemoteURL.getBodyURL(url).then(function(ret) {
	...
	try {
	 	//parse dxf object into readable object
